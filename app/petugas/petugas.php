...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="petugas.php">Perpustakaan</a>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <h5><p><marquee>Selamat Datang <font color= "blue"><a href="http://localhost/PerpustakaanAl-Ihsan/app/petugas/petugas.php"> Petugas</font></a> di Perpustakaan SMK Al-Ihsan Batujajar</marquee></p></h5>
