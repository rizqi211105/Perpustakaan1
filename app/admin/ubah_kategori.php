...
{   
    ...
    $data = mysqli_query($connection, "CALL Ubah_Kategori('$KategoriID', '$NamaKategori','$KodeBuku)");
            ...
            <div class="card-body">
              <form method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="KodeBuku" placeholder="Kode" class="form-control" value="<?php echo $KodeBuku;?>" required>
                </div>
