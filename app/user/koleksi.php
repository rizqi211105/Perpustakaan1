...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="user.php">Perpustakaan</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <table class="table table-striped table-sm table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a onclick="return confirm('Apakah Anda Yakin Menghapus Data Ini?');" href="koleksi_hapus.php?id=<?php echo $data['KoleksiID']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php 
                            } 
