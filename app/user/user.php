...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <a class="navbar-brand ps-3" href="user.php">Perpuatakaan</a>
            <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <h5><p><marquee>Selamat Datang <font color= "blue"><a href="http://localhost/PerpustakaanAl-Ihsan/app/user/user.php"> Pengguna</font></a> di Perpustakaan SMK Al-Ihsan Batujajar</marquee></p></h5>
                        ...
                        <h6><p>Jl. Galanggang RT 02 RW 09 Desa Galanggang Kec. Batujajar</p></h6></center>               
                    </div>
                </main>
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Perpustakaan Al-Ihsan Batujajar</div>
                        </div>
                    </div>
                </footer>
            </div>
